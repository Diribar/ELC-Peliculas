window.addEventListener("load", async () => {
	...
	let completo = document.querySelector("#altas #completo");
	let parte = document.querySelector("#altas #parte");
	let calidad = document.querySelector("#altas #calidad");
	let tipo = document.querySelector("#altas #tipo");
	let gratuito = document.querySelector("#altas #gratuito");
	let guardar = document.querySelector("form #altas .fa-floppy-disk");
	// Form - Inputs particulares
	let urlInput = document.querySelector("#altas input[name='url'");
	let prov_idInput = document.querySelector("#altas input[name='link_prov_id'");
	let calidadInput = document.querySelector("#altas #calidad .input");
	let tipoInput = document.querySelector("#altas #tipo .input");
	let completoInput = document.querySelector("#altas #completo .input");
	let parteInput = document.querySelector("#altas #parte .input");
	let gratuitoInput = document.querySelector("#altas #gratuito .input");

	// OK/Errores
	let provDesconocido = document.querySelector("#altas #url .fa-circle-question");
	let provConocido = document.querySelector("#altas #url .fa-circle-check");
	let iconosOK = document.querySelectorAll("#altas .fa-circle-check");
	let iconosError = document.querySelectorAll("#altas .fa-circle-xmark");
	let mensajesError = document.querySelectorAll("#altas .mensajeError");
	// Rutas
	...
	form.addEventListener("change", async (e) => {
		...
		if ((campo != "url" || !error.url) && e.target.name != "motivo") {
			let altas = actualizarDataEntry();
			errores = await fetch(rutaValidar + altas).then((n) => n.json());
