...
window.addEventListener("load", async () => {
	...
	ruta = "/producto/api/tridente/obtener-col-cap/?entidad=capitulos&id=";
	...
	capSelect.addEventListener("change", async () => {
		...
		// Obtener el capID
		let ruta = "/producto/api/tridente/obtener-cap-id/?entidad=capitulos";
	...
	ruta = "/producto/api/tridente/obtener-cap-ant-y-post/?id=";
