...
window.addEventListener("load", () => {
	// Variables
	let iconosAyuda = document.querySelectorAll("main #datos .input-error .fa-circle-question");
	let mensajesAyuda = document.querySelectorAll("main #datos .input-error .mensajeAyuda");
