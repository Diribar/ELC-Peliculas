...
// Rutas de vistas
router.get("/detalle", entValida, IDvalido, capturaInactivar, rutaCRUD, vista.prodDetalle_Form);
router.get("/edicion", ...edicion, capturaActivar, rutaCRUD, vista.prodEdicion_Form);
