...
module.exports = {
	...
	identidad: {
		form: async (req, res) => {
			...
			const ruta = publicoSinRev + "9-Provisorio";
		...
		guardar: async (req, res) => {
			...
			datos.ruta = req.file ? publicoSinRev + "9-Provisorio/" : archSinVersion + "1-Usuarios/DNI-Revisar/";
			...
			if (req.file) {
				...
				if (usuario.documAvatar)
					comp.gestionArchivos.elimina(publicoSinRev + "1-Usuarios/DNI-Revisar/", usuario.documAvatar);
