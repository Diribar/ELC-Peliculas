...
router.get(
	"/agregar/api/averiguar-producto-ya-en-bd-fa/",
	agregarAPI.averiguarProductoYaEnBD_FA
);
...
router.get(
	...
	soloUsuarios,
	agregarEJS.responsabilidad
);
// Controladores de EJS - 1. Palabras Clave
router.get(
	"/agregar/palabras_clave",
	soloUsuarios,
	agregarEJS.palabrasClaveForm
);
router.post(
	"/agregar/palabras_clave",
	soloUsuarios,
	agregarEJS.palabrasClaveGuardar
);
// Controladores de EJS - 2. Desambiguar, Copiar FA, Ya en nuestra BD
router.get(
	"/agregar/desambiguar",
	soloUsuarios,
	agregarEJS.desambiguarTMDB_Form
);
router.post(
	"/agregar/desambiguar",
	soloUsuarios,
	agregarEJS.desambiguarTMDB_Guardar
);
router.get(
	"/agregar/copiarfa",
	soloUsuarios,
	autorizadoFA,
	agregarEJS.copiarFA_Form
);
...
router.get(
	...
	soloUsuarios,
	validarProdYaEnBD,
	agregarEJS.datosDuros_Form
);
router.post(
	"/agregar/datos_duros",
	soloUsuarios,
	uploadFile.single("avatar"),
	agregarEJS.datosDuros_Guardar
);

// Controladores de EJS - 4. Datos Personalizados
router.get(
	"/agregar/datos_personalizados",
	soloUsuarios,
	validarProdYaEnBD,
	agregarEJS.DatosPersForm
);
router.post(
	"/agregar/datos_personalizados",
	soloUsuarios,
	agregarEJS.DatosPersGuardar
);
