...
module.exports = {
	...
	registrosConEsaFecha: async (req, res) => {
		...
		let diaDelAno_id = dia != "0" ? diasDelAno.find((n) => n.dia == objeto.dia && n.mes_id == objeto.mes_id).id : 400;
		let casos = await BD_genericas.obtieneTodosPorCondicion(entidad, {diaDelAno_id})
