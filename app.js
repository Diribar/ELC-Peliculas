...
app.set("views", [
	...
	path.resolve(__dirname, "./vistas/2.0-CRUD-Compartido"),	
	path.resolve(__dirname, "./vistas/2.1-C-Prod"),
	path.resolve(__dirname, "./vistas/2.1-C-Prod/Includes"),
	path.resolve(__dirname, "./vistas/2.2-RUD-Prod"),
	path.resolve(__dirname, "./vistas/2.2-RUD-Prod/Includes"),
	path.resolve(__dirname, "./vistas/2.3-RCLV"),
	path.resolve(__dirname, "./vistas/2.4-CRUD-Links"),
	path.resolve(__dirname, "./vistas/2.4-CRUD-Links/Includes"),
