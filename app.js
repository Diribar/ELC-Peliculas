...
app.set("views", [
	...
	path.resolve(__dirname, "./views/8-ProductosRUD"),
	path.resolve(__dirname, "./views/9-ElegirOpciones"),
]);
...
let rutaAgregarColeccion = require("./rutas_y_controladores/4-ColeccionesAgregar/RutasColecciones");
let rutaAgregarPelicula = require("./rutas_y_controladores/4-PeliculasAgregar/RutasPeliculas");
