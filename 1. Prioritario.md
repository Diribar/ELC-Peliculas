CRUD
- RCLV
	- Cuando en DP/Edición se hace click en Agregar/Edición:
		- El redireccionamiento se hace mediante JS
		- Se guardan los cambios de DP/Edición
		- Se abre la vista RCLV en la misma pestaña
	- En el url viene: 
		- Origen (DP/Edición). Si el origen es edición, se agrega la entidad + id del producto
		- Si el RCLV es para Agregar o Edición
	- Cuando se guardan los cambios, luego se continúa con la rutina de salir
	- Rutina de salir
		- Se si está en Edición RCLV, primero se inactiva la reserva
		- Se vuelve a DP/Edición con los datos del url
