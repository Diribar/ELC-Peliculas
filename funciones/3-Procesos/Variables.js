...
module.exports = {
	...
	orden: [
		...
		{nombre: "Por año de nacimiento del personaje", valor: "estreno", personajes: true, ascDes: true},
		{nombre: "Por año de ocurrencia del hecho", valor: "estreno", hechos: true, ascDes: true},
		{nombre: "Por año de nacimiento u ocurrencia", valor: "estreno", bhr: true, listado: true, ascDes: true},
		{nombre: "Por nombre del personaje", valor: "rclv", personajes: true, asc: true},
		{nombre: "Por nombre del hecho", valor: "rclv", hechos: true, asc: true},
		{nombre: "Por nombre del valor", valor: "rclv", valores: true, asc: true},
		{nombre: "Por nombre de la película o colección", valor: "producto", siempre: true, asc: true},
