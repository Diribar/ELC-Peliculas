...
--
-- Table structure for table `edic_capitulos`
--
...
CREATE TABLE `edic_capitulos` (
  ...
  `ELC_id` int(10) unsigned NOT NULL,
  ...
  `paises_id` varchar(18) DEFAULT NULL,
  ...
  `editada_por_id` int(10) unsigned NOT NULL,
  ...
  CONSTRAINT `edic_capitulos_ibfk_1` FOREIGN KEY (`coleccion_id`) REFERENCES `prod_colecciones` (`id`),
  CONSTRAINT `edic_capitulos_ibfk_10` FOREIGN KEY (`valor_id`) REFERENCES `rclv_valores` (`id`),
  CONSTRAINT `edic_capitulos_ibfk_11` FOREIGN KEY (`editada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `edic_capitulos_ibfk_12` FOREIGN KEY (`capturada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `edic_capitulos_ibfk_13` FOREIGN KEY (`status_registro_id`) REFERENCES `status_registro_prod` (`id`),
  CONSTRAINT `edic_capitulos_ibfk_2` FOREIGN KEY (`en_castellano_id`) REFERENCES `si_no_parcial` (`id`),
  CONSTRAINT `edic_capitulos_ibfk_3` FOREIGN KEY (`en_color_id`) REFERENCES `si_no_parcial` (`id`),
  CONSTRAINT `edic_capitulos_ibfk_4` FOREIGN KEY (`idioma_original_id`) REFERENCES `idiomas` (`id`),
  CONSTRAINT `edic_capitulos_ibfk_5` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `edic_capitulos_ibfk_6` FOREIGN KEY (`subcategoria_id`) REFERENCES `categorias_sub` (`id`),
  CONSTRAINT `edic_capitulos_ibfk_7` FOREIGN KEY (`publico_sugerido_id`) REFERENCES `publicos_sugeridos` (`id`),
  CONSTRAINT `edic_capitulos_ibfk_8` FOREIGN KEY (`personaje_historico_id`) REFERENCES `rclv_personajes_historicos` (`id`),
  CONSTRAINT `edic_capitulos_ibfk_9` FOREIGN KEY (`hecho_historico_id`) REFERENCES `rclv_hechos_historicos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `edic_colecciones`
--
...
CREATE TABLE `edic_colecciones` (
  ...
  KEY `capturada_por_id` (`capturada_por_id`),
  KEY `status_registro_id` (`status_registro_id`),
  CONSTRAINT `edic_colecciones_ibfk_1` FOREIGN KEY (`publico_sugerido_id`) REFERENCES `publicos_sugeridos` (`id`),
  CONSTRAINT `edic_colecciones_ibfk_10` FOREIGN KEY (`capturada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `edic_colecciones_ibfk_11` FOREIGN KEY (`status_registro_id`) REFERENCES `status_registro_prod` (`id`),
  CONSTRAINT `edic_colecciones_ibfk_2` FOREIGN KEY (`en_castellano_id`) REFERENCES `si_no_parcial` (`id`),
  CONSTRAINT `edic_colecciones_ibfk_3` FOREIGN KEY (`en_color_id`) REFERENCES `si_no_parcial` (`id`),
  CONSTRAINT `edic_colecciones_ibfk_4` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `edic_colecciones_ibfk_5` FOREIGN KEY (`subcategoria_id`) REFERENCES `categorias_sub` (`id`),
  CONSTRAINT `edic_colecciones_ibfk_6` FOREIGN KEY (`personaje_historico_id`) REFERENCES `rclv_personajes_historicos` (`id`),
  CONSTRAINT `edic_colecciones_ibfk_7` FOREIGN KEY (`hecho_historico_id`) REFERENCES `rclv_hechos_historicos` (`id`),
  CONSTRAINT `edic_colecciones_ibfk_8` FOREIGN KEY (`valor_id`) REFERENCES `rclv_valores` (`id`),
  CONSTRAINT `edic_colecciones_ibfk_9` FOREIGN KEY (`editada_por_id`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `edic_peliculas`
--
...
CREATE TABLE `edic_peliculas` (
  ...
  KEY `capturada_por_id` (`capturada_por_id`),
  KEY `status_registro_id` (`status_registro_id`),
  CONSTRAINT `edic_peliculas_ibfk_1` FOREIGN KEY (`publico_sugerido_id`) REFERENCES `publicos_sugeridos` (`id`),
  CONSTRAINT `edic_peliculas_ibfk_10` FOREIGN KEY (`editada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `edic_peliculas_ibfk_11` FOREIGN KEY (`capturada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `edic_peliculas_ibfk_12` FOREIGN KEY (`status_registro_id`) REFERENCES `status_registro_prod` (`id`),
  CONSTRAINT `edic_peliculas_ibfk_2` FOREIGN KEY (`en_castellano_id`) REFERENCES `si_no_parcial` (`id`),
  CONSTRAINT `edic_peliculas_ibfk_3` FOREIGN KEY (`en_color_id`) REFERENCES `si_no_parcial` (`id`),
  CONSTRAINT `edic_peliculas_ibfk_4` FOREIGN KEY (`idioma_original_id`) REFERENCES `idiomas` (`id`),
  CONSTRAINT `edic_peliculas_ibfk_5` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`id`),
  CONSTRAINT `edic_peliculas_ibfk_6` FOREIGN KEY (`subcategoria_id`) REFERENCES `categorias_sub` (`id`),
  CONSTRAINT `edic_peliculas_ibfk_7` FOREIGN KEY (`personaje_historico_id`) REFERENCES `rclv_personajes_historicos` (`id`),
  CONSTRAINT `edic_peliculas_ibfk_8` FOREIGN KEY (`hecho_historico_id`) REFERENCES `rclv_hechos_historicos` (`id`),
  CONSTRAINT `edic_peliculas_ibfk_9` FOREIGN KEY (`valor_id`) REFERENCES `rclv_valores` (`id`)
...
--
-- Table structure for table `penaliz_us_motivos`
--

DROP TABLE IF EXISTS `penaliz_us_motivos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `penaliz_us_usuarios`
--

DROP TABLE IF EXISTS `penaliz_us_usuarios`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `penaliz_us_usuarios` (
  ...
  `penaliz_por_id` int(10) unsigned NOT NULL,
  `penaliz_motivo_id` tinyint(3) unsigned NOT NULL,
  `comentario` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `usuario_id` (`usuario_id`),
  KEY `rol_usuario_id` (`rol_usuario_id`),
  KEY `penaliz_por_id` (`penaliz_por_id`),
  KEY `penaliz_motivo_id` (`penaliz_motivo_id`),
  CONSTRAINT `penaliz_us_usuarios_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `penaliz_us_usuarios_ibfk_2` FOREIGN KEY (`rol_usuario_id`) REFERENCES `roles_usuario` (`id`),
  CONSTRAINT `penaliz_us_usuarios_ibfk_3` FOREIGN KEY (`penaliz_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `penaliz_us_usuarios_ibfk_4` FOREIGN KEY (`penaliz_motivo_id`) REFERENCES `penaliz_us_motivos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `procesos_canonizacion`
--

DROP TABLE IF EXISTS `procesos_canonizacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Table structure for table `prod_borrados`
--

DROP TABLE IF EXISTS `prod_borrados`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prod_borrados` (
  ...
  CONSTRAINT `prod_borrados_ibfk_1` FOREIGN KEY (`pelicula_id`) REFERENCES `prod_peliculas` (`id`),
  CONSTRAINT `prod_borrados_ibfk_2` FOREIGN KEY (`coleccion_id`) REFERENCES `prod_colecciones` (`id`),
  CONSTRAINT `prod_borrados_ibfk_3` FOREIGN KEY (`capitulo_id`) REFERENCES `prod_capitulos` (`id`),
  CONSTRAINT `prod_borrados_ibfk_4` FOREIGN KEY (`motivo_id`) REFERENCES `prod_borrar_motivos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `prod_borrar_motivos`
--

DROP TABLE IF EXISTS `prod_borrar_motivos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `prod_borrar_motivos` (
  ...
  `orden` tinyint(3) unsigned NOT NULL,
  `nombre` varchar(30) NOT NULL,
  `penaliz_asoc_id` tinyint(3) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `penaliz_asoc_id` (`penaliz_asoc_id`),
  CONSTRAINT `prod_borrar_motivos_ibfk_1` FOREIGN KEY (`penaliz_asoc_id`) REFERENCES `penaliz_us_motivos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `prod_capitulos` (
  ...
  CONSTRAINT `prod_capitulos_ibfk_10` FOREIGN KEY (`valor_id`) REFERENCES `rclv_valores` (`id`),
  CONSTRAINT `prod_capitulos_ibfk_11` FOREIGN KEY (`creada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_capitulos_ibfk_12` FOREIGN KEY (`alta_analizada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_capitulos_ibfk_13` FOREIGN KEY (`editada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_capitulos_ibfk_14` FOREIGN KEY (`edic_analizada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_capitulos_ibfk_15` FOREIGN KEY (`capturada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_capitulos_ibfk_16` FOREIGN KEY (`status_registro_id`) REFERENCES `status_registro_prod` (`id`),
  ...
  CONSTRAINT `prod_capitulos_ibfk_8` FOREIGN KEY (`personaje_historico_id`) REFERENCES `rclv_personajes_historicos` (`id`),
  CONSTRAINT `prod_capitulos_ibfk_9` FOREIGN KEY (`hecho_historico_id`) REFERENCES `rclv_hechos_historicos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `prod_colecciones` (
  ...
  CONSTRAINT `prod_colecciones_ibfk_10` FOREIGN KEY (`alta_analizada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_colecciones_ibfk_11` FOREIGN KEY (`editada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_colecciones_ibfk_12` FOREIGN KEY (`edic_analizada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_colecciones_ibfk_13` FOREIGN KEY (`capturada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_colecciones_ibfk_14` FOREIGN KEY (`status_registro_id`) REFERENCES `status_registro_prod` (`id`),
  ...
  CONSTRAINT `prod_colecciones_ibfk_6` FOREIGN KEY (`personaje_historico_id`) REFERENCES `rclv_personajes_historicos` (`id`),
  CONSTRAINT `prod_colecciones_ibfk_7` FOREIGN KEY (`hecho_historico_id`) REFERENCES `rclv_hechos_historicos` (`id`),
  CONSTRAINT `prod_colecciones_ibfk_8` FOREIGN KEY (`valor_id`) REFERENCES `rclv_valores` (`id`),
  CONSTRAINT `prod_colecciones_ibfk_9` FOREIGN KEY (`creada_por_id`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `prod_links` (
  ...
  KEY `prod_links_FK` (`tipo_prod_id`),
  CONSTRAINT `prod_links_FK` FOREIGN KEY (`tipo_prod_id`) REFERENCES `tipos_producto` (`id`),
  ...
  CONSTRAINT `prod_links_ibfk_4` FOREIGN KEY (`proveedor_id`) REFERENCES `proveedores_links` (`id`),
  CONSTRAINT `prod_links_ibfk_5` FOREIGN KEY (`creada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_links_ibfk_6` FOREIGN KEY (`alta_analizada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_links_ibfk_7` FOREIGN KEY (`revisada_por_id`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `prod_links` VALUES (1,1,NULL,NULL,'youtube.com/watch?v=lpsa5we4lGM',1,1,'2020-07-04',10,'2022-02-16 00:00:00',NULL,NULL,NULL,NULL,2);
...
CREATE TABLE `prod_peliculas` (
  ...
  CONSTRAINT `prod_peliculas_ibfk_10` FOREIGN KEY (`creada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_peliculas_ibfk_11` FOREIGN KEY (`alta_analizada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_peliculas_ibfk_12` FOREIGN KEY (`editada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_peliculas_ibfk_13` FOREIGN KEY (`edic_analizada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_peliculas_ibfk_14` FOREIGN KEY (`capturada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `prod_peliculas_ibfk_15` FOREIGN KEY (`status_registro_id`) REFERENCES `status_registro_prod` (`id`),
  ...
  CONSTRAINT `prod_peliculas_ibfk_7` FOREIGN KEY (`personaje_historico_id`) REFERENCES `rclv_personajes_historicos` (`id`),
  CONSTRAINT `prod_peliculas_ibfk_8` FOREIGN KEY (`hecho_historico_id`) REFERENCES `rclv_hechos_historicos` (`id`),
  CONSTRAINT `prod_peliculas_ibfk_9` FOREIGN KEY (`valor_id`) REFERENCES `rclv_valores` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `proveedores_links`
--

DROP TABLE IF EXISTS `proveedores_links`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `proveedores_links` (
  ...
  `siempre_pago` tinyint(1) NOT NULL,
  `url` varchar(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `nombre` (`nombre`),
  UNIQUE KEY `url` (`url`)
...
--
-- Dumping data for table `proveedores_links`
--

LOCK TABLES `proveedores_links` WRITE;
/*!40000 ALTER TABLE `proveedores_links` DISABLE KEYS */;
INSERT INTO `proveedores_links` VALUES (1,1,'YouTube','PT-YouTube.jpg',0,'youtube.com'),(2,2,'Formed en Español','PT-Formed cast.jpg',0,'ver.formed.lat'),(3,3,'Formed','PT-Formed.jpg',0,'watch.formed.org'),(4,4,'Brochero','PT-Brochero.jpg',1,'brochero.org'),(5,5,'FamFlix','PT-FamFlix.jpg',1,'famflix.mx'),(6,6,'FamiPlay','PT-FamiPlay.jpg',1,'famiplay.com'),(7,7,'Goya Prod.','PT-Goya.jpg',1,'goyaproducciones.com'),(99,99,'Otro','PT-Otro.jpg',0,'');
/*!40000 ALTER TABLE `proveedores_links` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `rclv_hechos_historicos`
--

DROP TABLE IF EXISTS `rclv_hechos_historicos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rclv_hechos_historicos` (
  ...
  KEY `editada_por_id` (`editada_por_id`),
  KEY `capturada_por_id` (`capturada_por_id`),
  CONSTRAINT `rclv_hechos_historicos_ibfk_1` FOREIGN KEY (`dia_del_ano_id`) REFERENCES `dias_del_ano` (`id`),
  CONSTRAINT `rclv_hechos_historicos_ibfk_2` FOREIGN KEY (`creada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `rclv_hechos_historicos_ibfk_3` FOREIGN KEY (`editada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `rclv_hechos_historicos_ibfk_4` FOREIGN KEY (`capturada_por_id`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `rclv_personajes_historicos`
--

DROP TABLE IF EXISTS `rclv_personajes_historicos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rclv_personajes_historicos` (
  ...
  `ano` smallint(6) DEFAULT NULL,
  `nombre` varchar(30) NOT NULL,
  `proceso_canonizacion_id` varchar(3) DEFAULT NULL,
  ...
  UNIQUE KEY `nombre` (`nombre`),
  KEY `dia_del_ano_id` (`dia_del_ano_id`),
  KEY `proceso_canonizacion_id` (`proceso_canonizacion_id`),
  KEY `rol_iglesia_id` (`rol_iglesia_id`),
  KEY `creada_por_id` (`creada_por_id`),
  KEY `editada_por_id` (`editada_por_id`),
  KEY `capturada_por_id` (`capturada_por_id`),
  CONSTRAINT `rclv_personajes_historicos_ibfk_1` FOREIGN KEY (`dia_del_ano_id`) REFERENCES `dias_del_ano` (`id`),
  CONSTRAINT `rclv_personajes_historicos_ibfk_2` FOREIGN KEY (`proceso_canonizacion_id`) REFERENCES `procesos_canonizacion` (`id`),
  CONSTRAINT `rclv_personajes_historicos_ibfk_3` FOREIGN KEY (`rol_iglesia_id`) REFERENCES `roles_iglesia` (`id`),
  CONSTRAINT `rclv_personajes_historicos_ibfk_4` FOREIGN KEY (`creada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `rclv_personajes_historicos_ibfk_5` FOREIGN KEY (`editada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `rclv_personajes_historicos_ibfk_6` FOREIGN KEY (`capturada_por_id`) REFERENCES `usuarios` (`id`)
...
--
-- Table structure for table `rclv_valores`
--

DROP TABLE IF EXISTS `rclv_valores`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rclv_valores` (
  ...
  KEY `editada_por_id` (`editada_por_id`),
  KEY `capturada_por_id` (`capturada_por_id`),
  CONSTRAINT `rclv_valores_ibfk_1` FOREIGN KEY (`creada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `rclv_valores_ibfk_2` FOREIGN KEY (`editada_por_id`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `rclv_valores_ibfk_3` FOREIGN KEY (`capturada_por_id`) REFERENCES `usuarios` (`id`)
...
--
-- Table structure for table `roles_iglesia`
--

DROP TABLE IF EXISTS `roles_iglesia`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `roles_usuario` (
  ...
  `orden` tinyint(3) unsigned NOT NULL,
  `nombre` varchar(30) NOT NULL,
  `aut_input` tinyint(1) NOT NULL,
  `aut_gestion_prod` tinyint(1) NOT NULL,
  `aut_gestion_us` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `status_registro_prod`
--

DROP TABLE IF EXISTS `status_registro_prod`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `status_registro_prod` (
  ...
  `editada` tinyint(1) NOT NULL,
  `aprobada` tinyint(1) NOT NULL,
  `sugerida_borrar` tinyint(1) NOT NULL,
...
--
-- Table structure for table `status_registro_us`
--

DROP TABLE IF EXISTS `status_registro_us`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
INSERT INTO `tipos_producto` VALUES (1,'Trailer'),(2,'Película'),(3,'Colección'),(4,'Capítulo');
...
CREATE TABLE `usuarios` (
  ...
  `status_registro_id` tinyint(3) unsigned DEFAULT 1,
  `penaliz_motivo_id` tinyint(3) unsigned DEFAULT NULL,
  ...
  KEY `status_registro_id` (`status_registro_id`),
  KEY `penaliz_motivo_id` (`penaliz_motivo_id`),
  CONSTRAINT `usuarios_ibfk_1` FOREIGN KEY (`sexo_id`) REFERENCES `sexos` (`id`),
  CONSTRAINT `usuarios_ibfk_2` FOREIGN KEY (`pais_id`) REFERENCES `paises` (`id`),
  CONSTRAINT `usuarios_ibfk_3` FOREIGN KEY (`rol_usuario_id`) REFERENCES `roles_usuario` (`id`),
  CONSTRAINT `usuarios_ibfk_4` FOREIGN KEY (`rol_iglesia_id`) REFERENCES `roles_iglesia` (`id`),
  CONSTRAINT `usuarios_ibfk_5` FOREIGN KEY (`status_registro_id`) REFERENCES `status_registro_us` (`id`),
  CONSTRAINT `usuarios_ibfk_6` FOREIGN KEY (`penaliz_motivo_id`) REFERENCES `penaliz_us_motivos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-02-16 11:43:57
