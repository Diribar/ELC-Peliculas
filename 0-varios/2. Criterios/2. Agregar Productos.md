...
OK	- TMDB:	PalClave(TMDB), Desambiguar, 					DD, DP, Confirma, Conclusión, Detalle
	- FA:	PalClave(IM), TipoProducto(Pelic+FA), copiarFA, DD, DP, Confirma, Conclusión, Detalle
	- IM:	PalClave(TMDB), Desamb.(IM), TipoProd.(Pel+IM),
			PalClave(IM), TipoProducto(Pelic+IM),
												 			DD, DP, Confirma, Conclusión, Detalle

COLECCIONES
OK	- TMDB:	PalClave(TMDB), Desambiguar, 					DD, DP, Confirma, Conclusión, Detalle
	- FA:	PalClave(IM), TipoProducto(Colec+FA), copiarFA, DD, DP, Confirma, Conclusión, Detalle
...
OK	- TMDB:
	...
	- FA/IM:
		- PalClave(IM), TipoProducto(Capít+FA), copiarFA,	DD, DP, Confirma, Conclusión, Detalle
		- PalClave(IM), TipoProducto(Capít+IM),				DD, DP, Confirma, Conclusión, Detalle
	- IM, otra opción:
		- PalClave(TMDB), Desamb.(IM), TipoProd.(Cap+IM),	DD, DP, Confirma, Conclusión, Detalle
