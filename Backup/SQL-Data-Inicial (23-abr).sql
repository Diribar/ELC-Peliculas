...
values (1, 'Mail a validar'), (2, 'Mail validado'), (3, 'Datos ingresados')
;
INSERT INTO roles_usuario (id, nombre)
values (1, 'Usuario'), (2, 'Admin'), (3, 'Gerente')
;
INSERT INTO estados_eclesiales (id, nombre)
values ('LA', 'Laico'), ('RC', 'Religioso Consagrado'), ('DP', 'Diácono permanente'), ('SC', 'Sacerdote'), ('OB', 'Obispo'), ('CD', 'Cardenal')
;
INSERT INTO pais (iso_id, nombre)
...
;
INSERT INTO usuarios (id, email, status_id, rol_usuario_id, nombre, apellido, apodo, avatar, fecha_nacimiento, sexo, pais_id, estado_eclesial_id, contrasena, validacion_enviada_en, creado_en)
values 
(1, 'diegoiribarren2015@gmail.com', 2, 3, 'Diego', 'Iribarren', 'Diego', '1617370359746.jpg', '16/08/1969', 'masculino', 'AR', 'LA', '$2a$10$HgYM70RzhLepP5ypwI4LYOyuQRd.Cb3NON2.K0r7hmNkbQgUodTRm', '26/3/2021 12:00', '26/3/2021 12:05')
(2, 'sp2015w@gmail.com', 2, 2, 'Diego', 'Iribarren', 'Diego', '1617370359746.jpg', '16/08/1969', 'masculino', 'AR', 'LA', '$2a$10$HgYM70RzhLepP5ypwI4LYOyuQRd.Cb3NON2.K0r7hmNkbQgUodTRm', '26/3/2021 12:00', '26/3/2021 12:05')
;
...
;
INSERT INTO directores (id, tmdb, nombre)
VALUES (1, 234495, 'Giacomo Battiato')
;
INSERT INTO guion (id, tmdb, nombre)
VALUES (1, 2565414, 'Giacomo Battiato')
;
INSERT INTO musica (id, tmdb, nombre)
VALUES (1, 1259, 'Ennio Morricone')
;
INSERT INTO actores (id, tmdb, nombre)
...
;
INSERT INTO productores (id, tmdb, nombre)
VALUES (1, 473, 'Taodue Film')
;
INSERT INTO colecciones (id, tmdb, nombre_original, nombre_castellano)
...
VALUES 
(1, 1, 1, 'Karol Wojtyla')
(2, 2, 1, 'Hanna Tuszynska')
(3, 3, 1, 'Adam Zielinski')
(4, 4, 1, 'Julian Kordek')
(5, 5, 1, 'Maciej Nowak')
(6, 6, 1, 'Maria Pomorska')
(7, 7, 1, 'Hans Frank')
(8, 8, 1, 'padre Tomasz Zaleski')
(9, 9, 1, 'card. Stefan Wyszy?ski')
(10, 10, 1, 'Wislawa')
;
