...
VALUES (1, 'Mail a validar'), (2, 'Mail validado'), (3, 'Datos ingresados'), (4, 'Avatar ingresado')
;
INSERT INTO roles_usuario (id, nombre)
VALUES (1, 'Usuario'), (2, 'Admin'), (3, 'Gerente')
;
INSERT INTO estados_eclesiales (id, nombre, orden)
VALUES ('LA', 'Laico', 1), ('RC', 'Religioso Consagrado', 2), ('DP', 'Diácono permanente', 3), ('SC', 'Sacerdote', 4), ('OB', 'Obispo', 5), ('CD', 'Cardenal', 6)
;
...
id, email, contrasena, status_usuario_id, rol_usuario_id, nombre, apellido, apodo, avatar, fecha_nacimiento, sexo, pais_id, estado_eclesial_id, validacion_enviada_en, creado_en)
VALUES (1, 'diegoiribarren2015@gmail.com', '$2a$10$HgYM70RzhLepP5ypwI4LYOyuQRd.Cb3NON2.K0r7hmNkbQgUodTRm', 2, 3, 'Diego', 'Iribarren', 'Diego', '1617370359746.jpg', '1969-08-16', 'masculino', 'AR', 'LA', '2021-03-26', '2021-03-26'),(2, 'sp2015w@gmail.com', '$2a$10$HgYM70RzhLepP5ypwI4LYOyuQRd.Cb3NON2.K0r7hmNkbQgUodTRm', 2, 2, 'Diego', 'Iribarren', 'Diego', '1617370359746.jpg', '1969-08-16', 'masculino', 'AR', 'LA', '2021-03-26', '2021-03-26')
;
