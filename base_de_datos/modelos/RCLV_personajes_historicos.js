module.exports = (sequelize, dt) => {
	...
	entidad.associate = (n) => {
		...
		entidad.belongsTo(n.procesos_canonizacion, {
			as: "proceso_canonizacion",
			foreignKey: "proceso_canonizacion_id",
		});
		...
		entidad.belongsTo(n.status_registro, {
			as: "status_registro",
		...
		entidad.belongsTo(n.motivos_para_borrar, {
			as: "borrada_motivo",
			foreignKey: "borrada_motivo_id",
		});
