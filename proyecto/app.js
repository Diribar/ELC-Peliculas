...
global.intentos_Cookies = 2; // cantidad que se tolera
...
(async () => {
	...
	for (let prop in variables.filtrosConsultas)
		if (variables.filtrosConsultas[prop].default) filtrosConDefault[prop] = variables.filtrosConsultas[prop].default;
